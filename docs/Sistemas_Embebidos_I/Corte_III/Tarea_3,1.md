...
El sensor LDR cambiará su resistencia dependiendo de la intensidad de la luz. Cuando haya más luz, el valor será mayor; cuando haya oscuridad, será menor. El programa tomará esa lectura, la convertirá en un valor porcentual de 0% (oscuridad total) a 100% (luz máxima) y mostrará el resultado en el monitor serial.

---

### Esquemático de conexión 

Esquemático del circuito usado durante la actividad Luxometro.

![Diagrama del sistema](imgs/Tarea3,1.jpeg)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/2UASVJYo7g0?si=aWyFJu1rVuVLVqki" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>